...
public abstract class PermissionUtils {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("PERMISSION DENIED")//(R.string.location_permission_denied)
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(),"PERMISSION REQUIRED",// R.string.permission_required_toast,
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("PERMISSION RATIONALE LOCATION")//(R.string.permission_rationale_location)
